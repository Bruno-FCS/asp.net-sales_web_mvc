...
namespace SalesWebMvc.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            Seller s1 = new(1, "Bob Brown", "bob@email.com", 1000.0, new DateTime(1998, 4, 21), d1);
            Seller s2 = new(2, "Maria Green", "maria@email.com", 3500.0, new DateTime(1979, 12, 31), d2);
            Seller s3 = new(3, "Alex Grey", "alex@email.com", 2200.0, new DateTime(1988, 1, 15), d1);
            Seller s4 = new(4, "Martha Red", "martha@email.com", 3000.0, new DateTime(1993, 11, 30), d4);
            Seller s5 = new(5, "Donald Blue", "donald@email.com", 4000.0, new DateTime(2000, 1, 9), d3);
            Seller s6 = new(6, "Alex Pink", "alex@email.com", 3000.0, new DateTime(1997, 3, 4), d2);
